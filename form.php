        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15" style="text-align: center; color: black"><b>Fill the form</b></span>
              <form id="stripe-login" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                ...
                <div class="field padding-bottom--24">
                  <label>choose year of birth</label>
                ...
                <div class="field padding-bottom--24">
                  <label>indicate your abilities:</label>
                  <a>
                    <select
                      name="superpowers[]"
                      style="
                ...
                <div class="field field-checkbox padding-bottom--24 flex-flex align-center">
                  <label for="checkbox">
                    <input type="checkbox" name="ok">familiar with the rules.
                  </label>
                </div>

                <div class="field padding-bottom--24">
                  <input class="pole" type="submit" value="send"/>
                </div>
              </form>
            </div>
          </div>
